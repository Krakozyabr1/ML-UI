...
def eeg_freq_params(sig, fs, name):
    ...
    ret = []
    names = []
    ret.append(sum(delta))
    names.append(f"{name} delta en")
    ret.append(sum(theta))
    names.append(f"{name} theta en")
    ret.append(sum(alpha))
    names.append(f"{name} alpha en")
    ret.append(sum(beta1))
    names.append(f"{name} beta1 en")
    ret.append(sum(beta2))
    names.append(f"{name} beta2 en")
    ret.append(sum(gamma1))
    names.append(f"{name} gamma1 en")
    ret.append(sum(gamma2))
    names.append(f"{name} gamma2 en")
    ret.append(sum_all)
    names.append(f"{name} all en")

    ret.append(sum(delta) / sum_all)
    names.append(f"{name} delta/all en")
    ret.append(sum(theta) / sum_all)
    names.append(f"{name} theta/all en")
    ret.append(sum(alpha) / sum_all)
    names.append(f"{name} alpha/all en")
    ret.append(sum(beta1) / sum_all)
    names.append(f"{name} beta1/all en")
    ret.append(sum(beta2) / sum_all)
    names.append(f"{name} beta2/all en")
    ret.append(sum(gamma1) / sum_all)
    names.append(f"{name} gamma1/all en")
    ret.append(sum(gamma2) / sum_all)
    names.append(f"{name} gamma2/all en")
    ret.append(sum(alpha) / sum(beta1))
    names.append(f"{name} alpha/beta1 en")
    ret.append(sum(alpha) / sum(beta2))
    names.append(f"{name} alpha/beta2 en")
    ret.append(sum(alpha) / (sum(beta1) + sum(beta2)))
...
def hr_freq_params(sig, fs, name):
    ...
    names = []
    ret.append(sum(HF))
    names.append(f"{name} HF en")
    ret.append(sum(LF))
    names.append(f"{name} LF en")
    ret.append(sum(VLF))
    names.append(f"{name} VLF en")
    ret.append(sum(ULF))
    names.append(f"{name} ULF en")
    ret.append(sum(VHF))
    names.append(f"{name} VHF en")
    ret.append(sum_all)
    names.append(f"{name} all en")

    ret.append(sum(HF) / sum_all)
    names.append(f"{name} HF/all en")
    ret.append(sum(LF) / sum_all)
    names.append(f"{name} LF/all en")
    ret.append(sum(VLF) / sum_all)
    names.append(f"{name} VLF/all en")
    ret.append(sum(ULF) / sum_all)
    names.append(f"{name} ULF/all en")
    ret.append(sum(VHF) / sum_all)
    names.append(f"{name} VHF/all en")
    ret.append(sum(VLF) / sum(ULF))
    names.append(f"{name} VLF/ULF en")
    ret.append(sum(VLF) / sum(VHF))
    names.append(f"{name} VLF/VHF en")
    ret.append(sum(VHF) / (sum(ULF) + sum(VLF)))
...
def ecg_freq_params(sig, fs, name):
    ...
    names = []
    ret.append(sum(PLI))
    names.append(f"{name} PLI en")
    ret.append(sum(PT))
    names.append(f"{name} P/T en")
    ret.append(sum(MOT))
    names.append(f"{name} Motion en")
    ret.append(sum(QRS))
    names.append(f"{name} QRS en")
    ret.append(sum(MF))
    names.append(f"{name} MF en")
    ret.append(sum(BW))
    names.append(f"{name} BW en")
    ret.append(sum(HF))
    names.append(f"{name} HF en")
    ret.append(sum(EMG))
    names.append(f"{name} EMG en")
    ret.append(sum_all)
    names.append(f"{name} all en")

    ret.append(sum(PLI)/sum_all)
    names.append(f"{name} PLI/all en")
    ret.append(sum(PT)/sum_all)
    names.append(f"{name} P/T/all en")
    ret.append(sum(MOT)/sum_all)
    names.append(f"{name} Motion/all en")
    ret.append(sum(QRS)/sum_all)
    names.append(f"{name} QRS/all en")
    ret.append(sum(MF)/sum_all)
    names.append(f"{name} MF/all en")
    ret.append(sum(BW)/sum_all)
    names.append(f"{name} BW/all en")
    ret.append(sum(HF)/sum_all)
    names.append(f"{name} HF/all en")
    ret.append(sum(EMG)/sum_all)
